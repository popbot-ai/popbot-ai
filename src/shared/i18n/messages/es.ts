...
export const es = {
  ...
  'whatsNew.f2.p': 'El nuevo Opus insignia de Anthropic ya es el modelo predeterminado para los agentes de Claude. Los chats existentes de Opus se migran automáticamente.',
