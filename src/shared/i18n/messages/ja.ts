...
export const ja = {
  ...
  'search.tag.ticket': 'チケットのチャットのみ。特定のチケットはキーを追加（ticket:ENG-123）',
  'search.tag.cr': 'コードレビューのチャットのみ。特定の PR は番号を追加（cr:123）',
  'search.tag.lastWeek': '過去 7 日',
  'search.tag.lastMonth': '過去 30 日',
  'search.tag.fromUser': 'あなたが書いたもの',
  'search.tag.fromAgent': 'エージェントが書いたもの',
  'search.tag.fromTool': 'ツール呼び出しとその出力',
  'search.tag.tool': '特定のツール（tool:Bash）',
  'search.tag.agent': 'Codex のチャット（または agent:claude）',
  'search.tag.inArchive': 'アーカイブ済みのチャットのみ',
  'search.tag.chat': '名前に…を含むチャット（chat:login）',
  'work.emptyHint':
  ...
  'hosts.tab.loading': 'ホストに問い合わせ中…',
  'hosts.tab.local': 'このコンピュータ',
  'hosts.tab.meta': 'popbot-host {version}',
  'hosts.tab.unreachable': '接続不可',
  'hosts.tab.openChats': '開いているチャット {count}',
  'hosts.tab.noPools': 'スロットプールはありません。',
  'hosts.tab.noSlots': 'スロットなし',
  'hosts.tab.ephemeral': '一時ワークツリー',
  'hosts.tab.noChats': 'このホストにチャットはありません。',
  'hosts.tab.noHosts': 'ホストはまだありません。',
  ...
  'chat.input.stop': '停止',
  'chat.context.gaugeLabel': 'コンテキスト使用量',
  'chat.context.title': 'コンテキスト: {used} / {budget} トークン（{pct}%）· クリックでオプション',
  'chat.context.compactingTitle': 'コンテキストを圧縮中…',
  ...
  'auth.signIn.title': '{vendor} にサインイン',
  'auth.signIn.opening': 'サインインのためにブラウザーを開いています…',
  'auth.signIn.fallback': 'ブラウザーが開かない場合:',
  'auth.signIn.openLink': 'サインインページを開く',
  'auth.signIn.pasteCode': 'ブラウザーにコードが表示されたら、ここに貼り付けてください:',
  'auth.signIn.continue': '続行',
  'auth.signIn.done': 'サインインしました。',
  'auth.signIn.failed': 'サインインが完了しませんでした（終了コード {code}）。',
  'auth.signIn.retry': '再試行',
  ...
  'chat.ready.signedOut': 'インストール済みですが、サインインしていません',
  ...
  'branch.dialog.hostFree': '空きスロット {free} / {count}。',
  'branch.dialog.disabled.hostNoSlot': '{host} の {repo} に空きスロットがありません',
  ...
  'prefs.hosts.repos.title': 'このホスト上のリポジトリ',
  'prefs.hosts.repos.none': 'まだありません。下で追加してください。パスはホスト上のものです。',
  'prefs.hosts.repos.id': 'Id',
  'prefs.hosts.repos.path': 'ホスト上のパス',
  'prefs.hosts.repos.defaultBase': 'ベースブランチ',
  'prefs.hosts.repos.slotPrefix': 'スロット接頭辞',
  'prefs.hosts.repos.slotCount': 'スロット数',
  'prefs.hosts.repos.mode': 'モード',
  'prefs.hosts.repos.modeSlots': 'スロットプール',
  'prefs.hosts.repos.modeEphemeral': '一時',
  'prefs.hosts.repos.add': 'リポジトリを追加',
  'prefs.hosts.repos.remove': '削除',
  'prefs.hosts.repos.removeConfirm': '{host} から {repo} を削除しますか？ ワークツリーはディスクに残ります。',
  'prefs.hosts.repos.error': '保存できません: {error}',
  'prefs.hosts.local.desc': '常に存在し、削除できません。',
  'prefs.hosts.local.noRepos': 'リポジトリはまだありません。',
  'prefs.hosts.local.manage': 'リポジトリとスロットを管理',
