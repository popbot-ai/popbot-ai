...
export const ko = {
  ...
  'search.tag.ticket': '티켓 채팅만. 특정 티켓은 키를 추가하세요 (ticket:ENG-123)',
  'search.tag.cr': '코드 리뷰 채팅만. 특정 PR은 번호를 추가하세요 (cr:123)',
  'search.tag.lastWeek': '최근 7일',
  'search.tag.lastMonth': '최근 30일',
  'search.tag.fromUser': '내가 쓴 내용',
  'search.tag.fromAgent': '에이전트가 쓴 내용',
  'search.tag.fromTool': '도구 호출과 그 출력',
  'search.tag.tool': '특정 도구 (tool:Bash)',
  'search.tag.agent': 'Codex 채팅 (또는 agent:claude)',
  'search.tag.inArchive': '보관된 채팅만',
  'search.tag.chat': '이름에 …이 포함된 채팅 (chat:login)',
  'work.emptyHint':
  ...
  'hosts.tab.loading': '호스트에 문의 중…',
  'hosts.tab.local': '이 컴퓨터',
  'hosts.tab.meta': 'popbot-host {version}',
  'hosts.tab.unreachable': '연결 불가',
  'hosts.tab.openChats': '열린 채팅 {count}개',
  'hosts.tab.noPools': '슬롯 풀이 없습니다.',
  'hosts.tab.noSlots': '슬롯 없음',
  'hosts.tab.ephemeral': '임시 워크트리',
  'hosts.tab.noChats': '이 호스트에 채팅이 없습니다.',
  'hosts.tab.noHosts': '아직 호스트가 없습니다.',
  ...
  'chat.input.stop': '중지',
  'chat.context.gaugeLabel': '컨텍스트 사용량',
  'chat.context.title': '컨텍스트: {used} / {budget} 토큰 ({pct}%) · 클릭하여 옵션 보기',
  'chat.context.compactingTitle': '컨텍스트 압축 중…',
  ...
  'auth.signIn.title': '{vendor}에 로그인',
  'auth.signIn.opening': '로그인을 위해 브라우저를 여는 중…',
  'auth.signIn.fallback': '브라우저가 열리지 않으면:',
  'auth.signIn.openLink': '로그인 페이지 열기',
  'auth.signIn.pasteCode': '브라우저에 코드가 표시되면 여기에 붙여넣으세요:',
  'auth.signIn.continue': '계속',
  'auth.signIn.done': '로그인되었습니다.',
  'auth.signIn.failed': '로그인이 완료되지 않았습니다 (종료 코드 {code}).',
  'auth.signIn.retry': '다시 시도',
  ...
  'chat.ready.signedOut': '설치되었지만 로그인되지 않음',
  ...
  'branch.dialog.hostFree': '슬롯 {count}개 중 {free}개 비어 있음.',
  'branch.dialog.disabled.hostNoSlot': '{host}의 {repo}에 빈 슬롯이 없습니다',
  ...
  'prefs.hosts.repos.title': '이 호스트의 저장소',
  'prefs.hosts.repos.none': '아직 없습니다. 아래에서 추가하세요. 경로는 호스트 기준입니다.',
  'prefs.hosts.repos.id': 'Id',
  'prefs.hosts.repos.path': '호스트의 경로',
  'prefs.hosts.repos.defaultBase': '기준 브랜치',
  'prefs.hosts.repos.slotPrefix': '슬롯 접두사',
  'prefs.hosts.repos.slotCount': '슬롯 수',
  'prefs.hosts.repos.mode': '모드',
  'prefs.hosts.repos.modeSlots': '슬롯 풀',
  'prefs.hosts.repos.modeEphemeral': '임시',
  'prefs.hosts.repos.add': '저장소 추가',
  'prefs.hosts.repos.remove': '제거',
  'prefs.hosts.repos.removeConfirm': '{host}에서 {repo}을(를) 제거할까요? 워크트리는 디스크에 남습니다.',
  'prefs.hosts.repos.error': '저장할 수 없습니다: {error}',
  'prefs.hosts.local.desc': '항상 존재하며 제거할 수 없습니다.',
  'prefs.hosts.local.noRepos': '아직 저장소가 없습니다.',
  'prefs.hosts.local.manage': '저장소와 슬롯 관리',
